...
public class AccessoriesReceiptNote {
	...
	public AccessoriesReceiptNote(int id, List<ReceivedAccessory> receivedAccessories, float totalCost, Date receiptDay, Employee employee, Provider provider, String note) {
		this.id = id;
